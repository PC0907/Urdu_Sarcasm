...
if __name__ == "__main__":
    ...
    train_loader, test_loader, tokenizer = prepare_urdu_bert_data(
        '/kaggle/working/Urdu_Sarcasm/Data/Augmented_Data/augmented_data_10k_processed_train.tsv',
        '/kaggle/working/Urdu_Sarcasm/Data/Augmented_Data/augmented_data_10k_processed_test.tsv',
        batch_size=16
    )
